...
//////////////////////////////////////////////////////
	...
	#include "../Inc/Common.hlsl"
		...
		HEADER
		{
			...
			#ifdef MK_NATURAL
				RETURN_TARGET_TEX ConvertToColorSpace(half4(NaturalRel(SampleSourceTex(PASS_SOURCE_TEXTURE_2D(_SourceTex, sampler_SourceTex), UV_0).rgb, LUMA_SCALE), 1) * screenFade);
			#else
				RETURN_TARGET_TEX ConvertToColorSpace(half4(LuminanceThreshold(SampleSourceTex(PASS_SOURCE_TEXTURE_2D(_SourceTex, sampler_SourceTex), UV_0).rgb, GLARE_THRESHOLD, LUMA_SCALE), 1) * screenFade);
			#endif
		}
	#elif defined(MK_DEBUG_GLARE)
		#ifdef COMPUTE_SHADER	
